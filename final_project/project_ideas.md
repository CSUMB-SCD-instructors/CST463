...
Below is a list of possible project ideas.  I encourage you to select one from this list. If you want, you can find another problem, but it will need to be identified and approved by the instructor by the end of the first day of the project, at the latest.
...
- Classify x-ray images to see whether pneumonia is present
  ...
  - Hint: For this project, Grad-CAM (described in the Chollet text) is recommended
- Breast cancer detection from image
  - https://www.kaggle.com/datasets/paultimothymooney/breast-histopathology-images
  - Hint: For this project, Grad-CAM (described in the Chollet text) is recommended
- Image colorization
  - https://www.kaggle.com/datasets/shravankumar9892/image-colorization
  - hint: creating the dataset for this project is easy, but this project has proved tough (but I would love to see it succeed)
- Image upscaling
...
To suggest a project reach out to me to discuss it.  At a minimum I'll want to see that you've thought about:
- What dataset you will use for this
- What techniques you plan to use
- What the expected compute will be
- What benchmarks you'll use for assessing success
